                               ...
                               <tr class="table-row tbrow content strow">
                                 ...
                                 <td>
                                   <?php if ($request->attachment == "") { ?>
                                     <small>
                                       <center><span style="color: red;">No Attachments</span></center>
                                     </small>
                                   <?php } else { ?>
                                     <center>
                                 ...
                                 <td width="200px;">
                                   ...
                                   <a href="<?php echo base_url(); ?>requests/acceptRequest/<?php echo $request->entry_id; ?>" class="print btn btn-success btn-sm btn-outline">Accept
                                   </a>
                                   ...
                                   <label class="badge"><?php //echo $request->status; 
                                                        ?></label>
