...
$(document).ready(function() {
    ...
    $(document).on('click', '.sync-data-btn', function() {
        ...
        switch(syncType) {
            case 'departments':
                endpoint = '<?php echo base_url("biotime/syncDepartments"); ?>';
                break;
            case 'facilities':
                endpoint = '<?php echo base_url("biotime/syncFacilities"); ?>';
                break;
            case 'jobs':
                endpoint = '<?php echo base_url("biotime/syncJobs"); ?>';
                break;
            case 'employees':
                endpoint = '<?php echo base_url("biotime/syncEmployees"); ?>';
                break;
        }
