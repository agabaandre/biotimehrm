        ...
        <form class="update_user" enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>auth/updateUser">
          <div class="col-md-12">
            ...
            <select name="role" style="width:100%;" class="form-control role select2" required>
              ...
              ?>
                <option value="<?php echo $usergroup->group_id; ?>" <?php if ($user->role == $usergroup->group_id) {
                                                                      echo "selected";
          ...
          <div class="col-md-12" style="margin: 0 auto">
            ...
            <select onchange="getuserFacs($(this).val());" name="district_id" class="form-control select2 userdistrict" style="width:100%;">
              ...
              ?>
                <option value="<?php echo $district->district_id; ?>" <?php if ($user->district == $district->district) {
                                                                        echo "selected";
