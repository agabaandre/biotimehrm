...
<div class="row">
  <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
    ...
    <li class="nav-item">
      <a class="nav-link active" id="custom-tabs-three-messages-tab" href="<?php echo base_url() ?>schedules/attendance_schedules" role="tab" aria-controls="custom-tabs-three-messages" aria-selected="false">Attendance Schedules</a>
    </li>
        ...
        <table class="table table-striped thistbl">
          ...
          <tbody>
            ...
            <?php foreach ($schedules as $schedule) { ?>
              ...
              <?php //include('delete_attendance_sch_model.php'); 
              ?>
              <?php include('edit_attendance_sch_modal.php');  ?>
  ...
  <div class="col-md-4">
    <div class="card">
      <div class="card-header">
        <h5 class="">Create Attedance Schedule<h5>
      </div>
      <div class="card-body">
        ...
        <form role="form" id="schedule_form" method="post" action="<?php echo base_url(); ?>schedules/add_rosterschedule">
          ...
          <div class="form-group">
            ...
            <select name="purpose" class="form-control">
              ...
              <option value="a">Attenance</option>
            </select>
