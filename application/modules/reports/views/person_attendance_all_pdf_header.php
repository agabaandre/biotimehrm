...
<head>
	...
	<style>
		...
		table.paa-table { width: 100%; border-collapse: collapse; font-size: 9pt; margin-top: 6px; }
		table.paa-table th, table.paa-table td { border: 0.5px solid #7f8c8d; padding: 6px 8px; vertical-align: middle; }
		table.paa-table thead th { background: #1a5276; color: #fff; font-weight: bold; text-align: center; font-size: 8.5pt; }
		table.paa-table thead th.text-left { text-align: left; }
		table.paa-table tbody td { background: #fff; }
		table.paa-table tbody tr:nth-child(even) td { background: #f4f6f7; }
		table.paa-table .num { text-align: center; }
		table.paa-table .name-col { text-align: left; }
	</style>
</head>
<body>
	<table class="report-header" cellpadding="0" cellspacing="0">
		<tr>
			...
			<td>
				...
				<p class="report-subtitle"><?php echo isset($facility_name) && $facility_name !== '' ? htmlspecialchars($facility_name) . ' — ' : ''; ?>Period: <?php echo isset($period_label) ? htmlspecialchars($period_label) : ''; ?></p>
			</td>
		</tr>
	</table>
	<table class="paa-table">
		<thead>
			<tr>
				...
				<th class="text-left" style="width: 12%;">District</th>
				<th class="text-left" style="width: 14%;">Facility</th>
