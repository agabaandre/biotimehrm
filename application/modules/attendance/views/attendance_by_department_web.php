...
?>
	MONTHLY DEPARTMENT TO DUTY SUMMARY
...
<div class="header-row tbrow">
    ...
    <span class="cell stcell   cname">Department</span>
...
<div class="table-row tbrow strow">
	...
	<b id="name">. &nbsp;<span onclick="$('.trigger').click();"><?php echo $sum['department'];?></span></b>
</span>

	<span class="cell stcell  cname" data-label="Name"><?php echo $sum['department'] ?></span>
