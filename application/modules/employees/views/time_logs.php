...
<section class="col-lg-12">
            ...
            <div class="card">
              ...
              <a href="<?php echo base_url()?>employees/attCsv/<?php echo $this->input->post('date_from').'/'.$this->input->post('date_to').'/'.'person'.$this->input->post('name').'/'.'position-'.urlencode(str_replace(' ','_',$this->input->post('job'))); ?>" target="" class="btn bt-sm bg-gray-dark color-pale"  style="width:100px;" ><i class="fa fa-file-excel"></i>CSV</a><br/><br/>
              <a href="<?php echo base_url()?>employees/print_timelogs/<?php echo $this->input->post('date_from').'/'.$this->input->post('date_to').'/'.'person'.$this->input->post('name').'/'.'position-'.urlencode(str_replace(' ','_',$this->input->post('job'))); ?>" target="" class="btn bt-sm bg-gray-dark color-pale"  style="width:100px;" ><i class="fa fa-file-excel"></i>PDF</a>
