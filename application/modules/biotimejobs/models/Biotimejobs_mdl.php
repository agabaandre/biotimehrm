...
class Biotimejobs_mdl extends CI_Model
{
    ...
    public function get_attendance_data($date, $empcode = FALSE, $terminal_sn = FALSE)
    {
        ...
        $data = $pg->query("SELECT emp_code, terminal_sn, area_alias, longitude, latitude, punch_state, DATE(punch_time) as punch_date FROM iclock_transaction WHERE DATE(punch_time) = '$date' $empcode $terminal_sn LIMIT 1O")->result();
