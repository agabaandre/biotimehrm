            ...
            <div class="col-xl-4 col-md-12">
                <div class="card card-">
                    ...
                    <div class="card-body">
                        ...
                        <div
                            class="d-flex justify-content-between align-items-center mb-3 border-bottom mb-3 border-info">
                            ...
                            <ul class="nav nav-pills" style="margin: 0 auto; margin-top:4px;">
                                ...
                                <div class="row">
                                    <?php foreach ($colors as $color) { ?>
                                        <li class="nav-item">
                                            <a class="btn btn-flat btnkey"
                                                style="background-color:<?php echo $color->color; ?>;"><?php echo $color->schedule; ?></a>
                                        </li>
                                    <?php } ?>
                                </div>
                            </ul>
                        ...
                        <div class="card-body">
                            <ul class="nav nav-pills" style="margin: 0 auto; margin-top:4px;">
                                ...
                                <div class="row">
                                    <?php foreach ($colors as $color) { ?>
                                        <li class="nav-item">
                                            <a class="btn btn-flat rbtnkey"
                                                style="background-color:<?php echo $color->color; ?>;"
                                                data-toggle="tab"><?php echo $color->schedule; ?></a>
                                        </li>
                                    <?php } ?>
                                </div>
                            </ul>
