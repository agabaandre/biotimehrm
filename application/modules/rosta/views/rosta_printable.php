		...
		<tbody>
			...
			?>
				<tr>
					...
					<td class='cost text-left' style="text-align:left;"><?php echo $singleduty['fullname']; ?></td>
					<td class='cost text-left' style="text-align:left;"><?php echo character_limiter($singleduty['job'], 15); ?></td>
					<?php
					//days in a month
