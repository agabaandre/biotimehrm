										...
										?>
											<td style="border-bottom: 1px solid; border-left: 0px solid; border-top: 1px solid; border-right: 1px solid; text-align: center; ">
												...
												?>
													...
													?>
														<input type="text" style="padding:0px; text-align: center; border:0px; text-transform:uppercase; " class="update tracker" did="<?php echo $ddate; ?>" day="<?php echo $i; ?>" pid="<?php echo $singleduty['ihris_pid']; ?>" pattern="[A-Za-z]+" size="1px" maxlength="1" title="P only for present" value="" <?php echo dayState($singleduty[$day]); ?>>
												<?php }
												} else {
													// not scheduled
													echo "N/A";
