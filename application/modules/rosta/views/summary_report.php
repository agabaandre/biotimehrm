      ...
      <!-- Small boxes (Stat box) -->
        <div class="row">
			...
			<div class="col-md-4">
				...
				/*if(count($sums)>0)
				{ */?>
				<a href="<?php echo base_url() ?>rosta/print_summary/<?php echo $year."-".$month; ?>" style="" class="print btn btn-success btn-sm" target="_blank"><i class="fa fa-print"></i>Print
				</a> <?php //} ?>
			</div>
      ...
      <div class="row">
          <div class="col-lg-12">
			...
			<div class="header-row tbrow">
			    <span class="cell stcell  stcell tbprimary cnumber"># <b id="name"></b></span>
			    <span class="cell stcell  stcell  cname">Name</span>
				<span class="cell stcell ">Day </span>
				<span class="cell stcell ">Off</span>
				<span class="cell stcell ">Annual</span>
				<span class="cell stcell ">Study</span>
				<span class="cell stcell ">Maternity</span>
			   <span class="cell stcell ">Other</span>
			...
			<div class="table-row tbrow content strow">
				...
				<span class="cell stcell " data-label="D"><?php echo $sum['D'];?></span>
				<span class="cell stcell " data-label="O"><?php echo $sum['O'];?></span>
				<span class="cell stcell " data-label="A"><?php echo $sum['A'];?></span>
				<span class="cell stcell " data-label="S"><?php echo $sum['S'];?></span>
				<span class="cell stcell " data-label="M"><?php echo $sum['M'];?></span>
				<span class="cell stcell " data-label="Z"><?php echo $sum['Z'];?></span>
			</div>
