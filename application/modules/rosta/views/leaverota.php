										...
										<div class="table-row tbrow">
											...
											?>
												<span class="cell" data-label="Day<?php echo $i; ?>">
													...
													?>
														<input type="text" style="padding:0px; text-align: center;" class="update duty" id="<?php echo $year . "-" . $month . "-" . $d . $singleduty['ihris_pid']; ?>" day="<?php echo $i; ?>" pid="<?php echo $singleduty['ihris_pid']; ?>" pattern="[A-Za-z]+" size="1px" maxlength="1" title="Use Letters for Leave" value="<?php echo $matches[$singleduty['day' . $i] . $singleduty['ihris_pid']]; ?>" <?php echo $state; ?>>
													<?php } else {
													?>
