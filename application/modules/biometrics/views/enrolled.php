    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <section class="col-lg-12 ">
          ...
          <?php $staffs = Modules::run('biometrics/get_enrolled');
            ...
            <tbody>
              ...
              ?>
                ...
                <tr>
                  ...
                  <td data-label="ATT STATUS"><?php if ($staff->att_status == 1) echo "<p style='color:green;'>Active</p>";
                                              else {
                                                echo "<p style='color:green;'>In-Active</p>";
                                              }; ?></td>
